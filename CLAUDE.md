...
| `fuse_violations.py` | AIS × detection fusion (stage 4, P3) | Matches a run's detections against normalized AIS positions with a velocity-aware gate; emits dark-vessel `violation_events.json` |
